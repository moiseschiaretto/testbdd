...
public class AutoDriver {
	 ...
	 * version of ChromeDriver only supports Chrome version 87 Current browser
	 * version is 89.0.4389.72 with binary path C:\Program Files
	...
	private static final String LOCAL_CHROMEDRIVER = "src/test/resources/chomedriver/chromedriver.exe";
	private static final String LOCAL_GECKODRIVER = "src/test/resources/geckodriver/geckodriver.exe";
